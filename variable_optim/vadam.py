"""
The Pytorch Implementation of VAdam / NVRM-Adam.

The algorithm is based on the paper Artificial Neural Variability.
...
class VAdam(Optimizer):
    r"""Implements Variable Adaptive Momentum Estimation (VAdam) algorithm.
    Arguments:
        params (iterable): iterable of parameters to optimize or dicts defining
            parameter groups
        lr (float, optional): learning rate (default: 1e-3)
        variability (float, optional): neural variability (default: 0.01)
        num_iters (int, optional): the number of iterations per epoch (default: 0)
